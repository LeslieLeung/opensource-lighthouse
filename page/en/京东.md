...
A total of 69 projects, 20 active projects in the last six months, 1 teams, and 4841 stars.
...
| [joyrpc](https://github.com/jd-opensource/joyrpc) | high-performance, high-extensibility Java rpc framework. | Java | 451 | Apache License 2.0 | 2019-09-12 | 2024-08-30 | 2024-04-06 |
...
| [9n-mpc](https://github.com/jd-opensource/9n-mpc) | None | Java | 113 | Apache License 2.0 | 2020-09-07 | 2024-08-20 | 2024-08-28 |
...
| [drip-table](https://github.com/jd-opensource/drip-table) | A tiny and powerful enterprise-class solution for building lowcode tables. 轻量、强大的企业级表格可视化搭建解决方案。 | TypeScript | 1431 | MIT License | 2021-12-07 | 2024-09-05 | 2024-09-05 |
...
| [sql-analysis](https://github.com/jd-opensource/sql-analysis) | 针对大促、日常系统稳定性隐患-慢sql的预防和排查，基于Mybatis插件设计的一款慢sql分析组件，区别于主流的基于慢sql日志分析和预警，实时根据Explain分析结果分析 | Java | 117 | Apache License 2.0 | 2023-10-25 | 2024-08-29 | 2024-05-16 |
...
| [joylive-agent](https://github.com/jd-opensource/joylive-agent) | Java bytecode enhancement framework for traffic governance in multi-live (unit) scenarios. 基于字节码增强的面向应用多活和单元化的微服务流量治理框架。 | Java | 106 | Apache License 2.0 | 2024-04-25 | 2024-09-06 | 2024-09-06 |
| [joylive-injector](https://github.com/jd-opensource/joylive-injector) | A webhook component for automatically injecting the joylive-agent into Java applications in the K8s environment. 适用于K8s环境中，为Java应用程序自动注入joylive-agent的Webhook组件。 | Go | 10 | Apache License 2.0 | 2024-04-25 | 2024-09-02 | 2024-08-27 |
