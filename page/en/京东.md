...
A total of 98 projects, 20 active projects in the last six months, 1 teams, and 26671 stars.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [nutui](https://github.com/jd-opensource/nutui) | 京东风格的移动端 Vue 组件库，支持多端小程序(A Vue.js UI Toolkit for Mobile Web) | Vue | 6341 | MIT License | 2018-01-22 | 2025-05-26 | 2024-12-17 |
| [taro-ui](https://github.com/jd-opensource/taro-ui) | 一款基于 Taro 框架开发的多端 UI 组件库 | TypeScript | 4652 | MIT License | 2018-07-02 | 2025-05-27 | 2024-08-29 |
| [awesome-taro](https://github.com/jd-opensource/awesome-taro) | 多端统一开发框架 Taro 优秀学习资源汇总 | None | 2866 | - | 2018-11-08 | 2025-05-26 | 2024-04-11 |
| [jdchain_bak](https://github.com/jd-opensource/jdchain_bak) | JD Chain is JD.COM's open source blockchain project, with the goal of creating enterprise blockchain system that makes data exchange easier and more efficient. | Shell | 551 | Apache License 2.0 | 2019-03-26 | 2025-05-27 | 2022-10-21 |
...
| [micro-app](https://github.com/jd-opensource/micro-app) | A simple, efficient and powerful micro front-end framework. 一款简约、高效、功能强大的微前端框架 | CSS | 5935 | MIT License | 2021-06-24 | 2025-05-28 | 2025-05-26 |
...
| [nutui-bingo](https://github.com/jd-opensource/nutui-bingo) | Bingo - 基于 NutUI 的抽奖组件 | Vue | 458 | - | 2021-09-08 | 2025-05-26 | 2023-02-14 |
...
| [drip-table](https://github.com/jd-opensource/drip-table) | A tiny and powerful enterprise-class solution for building lowcode tables. 轻量、强大的企业级表格可视化搭建解决方案。 | TypeScript | 1586 | MIT License | 2021-12-07 | 2025-05-27 | 2025-02-21 |
...
| [joylive-agent](https://github.com/jd-opensource/joylive-agent) | Java bytecode enhancement framework for traffic governance in multi-live (unit) scenarios. 基于字节码增强的面向应用多活和单元化的微服务流量治理框架。 | Java | 190 | Apache License 2.0 | 2024-04-25 | 2025-05-28 | 2025-05-28 |
| [joylive-injector](https://github.com/jd-opensource/joylive-injector) | A webhook component for automatically injecting the joylive-agent into Java applications in the K8s environment. 适用于K8s环境中，为Java应用程序自动注入joylive-agent的Webhook组件。 | Go | 13 | Apache License 2.0 | 2024-04-25 | 2025-05-28 | 2025-05-28 |
...
| [joylive-demo](https://github.com/jd-opensource/joylive-demo) | Project demo used to verify joylive-agent feasibility. 用于验证joylive-agent可行性的演示项目。 | Java | 0 | Apache License 2.0 | 2025-03-04 | 2025-05-28 | 2025-05-28 |
