...
A total of 98 projects, 19 active projects in the last six months, 1 teams, and 26568 stars.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [nutui](https://github.com/jd-opensource/nutui) | 京东风格的移动端 Vue 组件库，支持多端小程序(A Vue.js UI Toolkit for Mobile Web) | Vue | 6324 | MIT License | 2018-01-22 | 2025-05-06 | 2024-12-17 |
| [taro-ui](https://github.com/jd-opensource/taro-ui) | 一款基于 Taro 框架开发的多端 UI 组件库 | TypeScript | 4641 | MIT License | 2018-07-02 | 2025-05-06 | 2024-08-29 |
...
| [jdchain_bak](https://github.com/jd-opensource/jdchain_bak) | JD Chain is JD.COM's open source blockchain project, with the goal of creating enterprise blockchain system that makes data exchange easier and more efficient. | Shell | 549 | Apache License 2.0 | 2019-03-26 | 2025-05-05 | 2022-10-21 |
...
| [micro-app](https://github.com/jd-opensource/micro-app) | A simple, efficient and powerful micro front-end framework. 一款简约、高效、功能强大的微前端框架 | CSS | 5913 | MIT License | 2021-06-24 | 2025-05-06 | 2025-04-29 |
...
| [jd-easyflow](https://github.com/jd-opensource/jd-easyflow) | A Smart Extensible Powerful Flow Engine | JavaScript | 214 | Other | 2022-01-19 | 2025-05-06 | 2025-02-28 |
...
| [joylive-agent](https://github.com/jd-opensource/joylive-agent) | Java bytecode enhancement framework for traffic governance in multi-live (unit) scenarios. 基于字节码增强的面向应用多活和单元化的微服务流量治理框架。 | Java | 187 | Apache License 2.0 | 2024-04-25 | 2025-05-06 | 2025-05-06 |
| [joylive-injector](https://github.com/jd-opensource/joylive-injector) | A webhook component for automatically injecting the joylive-agent into Java applications in the K8s environment. 适用于K8s环境中，为Java应用程序自动注入joylive-agent的Webhook组件。 | Go | 13 | Apache License 2.0 | 2024-04-25 | 2025-05-06 | 2025-05-06 |
...
| [joylive-demo](https://github.com/jd-opensource/joylive-demo) | Project demo used to verify joylive-agent feasibility. 用于验证joylive-agent可行性的演示项目。 | Java | 0 | Apache License 2.0 | 2025-03-04 | 2025-05-06 | 2025-05-06 |
