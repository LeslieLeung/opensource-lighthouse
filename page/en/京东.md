...
A total of 92 projects, 19 active projects in the last six months, 1 teams, and 26059 stars.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [nutui](https://github.com/jd-opensource/nutui) | 京东风格的移动端 Vue 组件库，支持多端小程序(A Vue.js UI Toolkit for Mobile Web) | Vue | 6264 | MIT License | 2018-01-22 | 2025-02-24 | 2024-12-17 |
...
| [joyrpc](https://github.com/jd-opensource/joyrpc) | high-performance, high-extensibility Java rpc framework. | Java | 465 | Apache License 2.0 | 2019-09-12 | 2025-02-19 | 2024-04-06 |
...
| [micro-app](https://github.com/jd-opensource/micro-app) | A simple, efficient and powerful micro front-end framework. 一款简约、高效、功能强大的微前端框架 | CSS | 5797 | MIT License | 2021-06-24 | 2025-02-24 | 2025-02-24 |
...
| [drip-table](https://github.com/jd-opensource/drip-table) | A tiny and powerful enterprise-class solution for building lowcode tables. 轻量、强大的企业级表格可视化搭建解决方案。 | TypeScript | 1488 | MIT License | 2021-12-07 | 2025-02-23 | 2025-02-21 |
...
| [nutui-react-native](https://github.com/jd-opensource/nutui-react-native) | JD-style mobile UI components based on React Native that support users to develop APP and H5. | TypeScript | 138 | MIT License | 2023-01-12 | 2025-02-10 | 2025-02-17 |
...
| [sql-analysis](https://github.com/jd-opensource/sql-analysis) | 针对大促、日常系统稳定性隐患-慢sql的预防和排查，基于Mybatis插件设计的一款慢sql分析组件，区别于主流的基于慢sql日志分析和预警，实时根据Explain分析结果分析 | Java | 179 | Apache License 2.0 | 2023-10-25 | 2025-02-22 | 2025-01-16 |
...
| [joylive-agent](https://github.com/jd-opensource/joylive-agent) | Java bytecode enhancement framework for traffic governance in multi-live (unit) scenarios. 基于字节码增强的面向应用多活和单元化的微服务流量治理框架。 | Java | 163 | Apache License 2.0 | 2024-04-25 | 2025-02-24 | 2025-02-24 |
| [joylive-injector](https://github.com/jd-opensource/joylive-injector) | A webhook component for automatically injecting the joylive-agent into Java applications in the K8s environment. 适用于K8s环境中，为Java应用程序自动注入joylive-agent的Webhook组件。 | Go | 12 | Apache License 2.0 | 2024-04-25 | 2025-02-21 | 2025-02-21 |
