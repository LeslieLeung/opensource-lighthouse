...
A total of 49 projects, 25 active projects in the last six months, 1 teams, and 11218 stars.
...
| [kbear](https://github.com/ctripcorp/kbear) | Enterprise Kafka Solution | Java | 50 | Apache License 2.0 | 2019-02-21 | 2024-07-10 |
...
| [C-OCR](https://github.com/ctripcorp/C-OCR) |   C-OCR是携程自研的OCR项目，主要包括身份证、护照、火车票、签证等旅游相关证件、材料的识别。  项目包含4个部分，拒识、检测、识别、后处理。 | Java | 2368 | - | 2019-04-11 | 2024-07-11 |
...
| [flybirds](https://github.com/ctripcorp/flybirds) | 基于自然语言的，跨端跨框架 BDD UI 自动化测试方案，BDD testing, Python style, Present by Trip Flight | Python | 825 | MIT License | 2021-12-30 | 2024-07-08 |
...
| [tripdocs](https://github.com/ctripcorp/tripdocs) | TripDocsSDK是基于携程内部在线文档编辑器内核，提炼的一款通用的，现代的、稳定的、支持协同的、可用于生产环境的在线文档编辑器 | TypeScript | 141 | MIT License | 2023-01-11 | 2024-07-10 |
