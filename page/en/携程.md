...
A total of 49 projects, 9 active projects in the last six months, 1 teams, and 11835 stars.
...
| [x-pipe](https://github.com/ctripcorp/x-pipe) | X-Pipe是由携程框架部门研发的Redis多数据中心复制管理系统。基于Redis的Master-Slave复制协议，实现低延时、高可用的Redis多数据中心、跨公网数据复制，并且提供一键机房切换，复制监控、异常报警等功能。开源版本和携程内部生产环境版本一致。 | Java | 2081 | Apache License 2.0 | 2016-03-29 | 2025-11-18 | 2025-11-18 |
| [Redis-On-Rocks](https://github.com/ctripcorp/Redis-On-Rocks) | Redis in CTRIP | C | 216 | BSD 3-Clause "New" or "Revised" License | 2016-04-08 | 2025-11-19 | 2025-11-19 |
...
| [CRN](https://github.com/ctripcorp/CRN) | CRN是Ctrip React Native简称，由携程无线平台研发团队基于React Native框架优化，定制成稳定性和性能更佳、也更适合业务场景的跨平台开发框架。 | JavaScript | 1480 | MIT License | 2019-04-11 | 2025-11-19 | 2020-10-16 |
...
| [TripLink](https://github.com/ctripcorp/TripLink) | TripLink | Java | 8 | - | 2021-07-27 | 2025-10-24 | 2025-10-24 |
...
| [flybirds](https://github.com/ctripcorp/flybirds) | 基于自然语言的，跨端跨框架 BDD UI 自动化测试方案，BDD testing, Python style, Present by Trip Flight | Python | 906 | MIT License | 2021-12-30 | 2025-11-20 | 2025-08-27 |
...
| [tripdocs](https://github.com/ctripcorp/tripdocs) | TripDocsSDK是基于携程内部在线文档编辑器内核，提炼的一款通用的，现代的、稳定的、支持协同的、可用于生产环境的在线文档编辑器 | TypeScript | 228 | MIT License | 2023-01-11 | 2025-11-04 | 2023-03-12 |
