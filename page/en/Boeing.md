...
A total of 35 projects, 5 active projects in the last six months, 1 teams, and 638 stars.
...
| [config-file-validator](https://github.com/Boeing/config-file-validator) | Cross-platform CLI tool to validate configuration files across 18 formats. Syntax and schema validation with JSON Schema, XSD, and SchemaStore integration. Written in Go. | Go | 514 | Apache License 2.0 | 2022-12-06 | 2026-08-23 | 2026-08-21 |
...
| [validate-configs-action](https://github.com/Boeing/validate-configs-action) | :octocat: Github Action to validate your config files using the config-file-validator | Go | 2 | Apache License 2.0 | 2025-10-24 | 2026-08-21 | 2026-08-21 |
