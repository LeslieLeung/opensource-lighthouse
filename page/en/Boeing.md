...
A total of 35 projects, 5 active projects in the last six months, 1 teams, and 636 stars.
...
| [config-file-validator](https://github.com/Boeing/config-file-validator) | Cross-platform CLI tool to validate configuration files across 18 formats. Syntax and schema validation with JSON Schema, XSD, and SchemaStore integration. Written in Go. | Go | 512 | Apache License 2.0 | 2022-12-06 | 2026-08-06 | 2026-08-10 |
...
| [linux](https://github.com/Boeing/linux) | Linux kernel stable tree mirror | C | 0 | Other | 2024-04-22 | 2024-07-08 | 2026-08-09 |
...
| [standard-evaluator](https://github.com/Boeing/standard-evaluator) | Python library to wrap simulation codes for integration with MDAO systems, and replace simulations with surrogate models. | HTML | 13 | Other | 2024-09-18 | 2026-07-17 | 2026-07-23 |
...
| [validate-configs-action](https://github.com/Boeing/validate-configs-action) | :octocat: Github Action to validate your config files using the config-file-validator | Go | 2 | Apache License 2.0 | 2025-10-24 | 2026-06-29 | 2026-07-13 |
